...
module.exports = function(configOptions){
	...
	if(configOptions) {
		...
		io.sockets.on('connection', function(socket){
			scopeSocket = socket;
			console.log('socket connected: ', scopeSocket);
	...
	return {
		...
		acceptAsyncUpload: function(req, res, next) {
			...
			console.log("dir: " + process.cwd() + '/_uploads/');
			...
			form.on('progress', function(bytesReceived, bytesExpected){
				...
				if(scopeSocket) {
					scopeSocket.emit('uploadProgress', percent);
					console.log('progress for socket '+ scopeSocket.id +' is: ' + percent);
				}
			});
